...
class TestInputValidation:
    ...
    def test_invalid_user_pseudo_id(self):
        ...
        assert "alphanumeric characters, hyphens, underscores, and periods" in str(exc_info.value)
...
class TestInputValidationEndpoint:
    ...
    def test_invalid_event_name_returns_422(self, client):
        ...
        assert response.status_code in [422, 500]  # Depends on how EventPayload is defined
